...
const routes = [
    ...
    },
    {
        ...
        children: [
            ...
            {
                path: 'stats',
                loadChildren: () => __webpack_require__.e(/*! import() */ "angular_src_app_modules_options_pages_options_stats_stats_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./pages/options/stats/stats.module */ 3812)).then(m => m.StatsModule)
            }
        ],
    },
];
